...
#users
alex = User.create(name: "Alex", age: 29, username: "alex123", password: "123456789")
nick = User.create(name: "Nick", age: 22, username: "SauteedShrooms", password: "123456789")
john = User.create(name: "Paul", age: 12, username: "JohnDoe", password: "123456789")
